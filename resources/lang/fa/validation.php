...
return [
    ...
    */
    'attributes' => [
        ...
        "lon" => "عرض جغرافیایی",
        "accepted" => "پذیرش",
        "parent_id" => "شناسه بالاتر",
        "carmodel" => "مدل خودرو",
        "mechanic_type" => "نوع مکانیکی",
        "i_know_problem" => "مشکل را می دانم",
        "problem" => "مشکل",
        "services" => "سرویس ها",
        "service" => "سرویس",
        "mechanic" => "مکانیک",
        "status" => "وضعیت",
        "delivery_step" => "مرحله تحویل",
        "price" => "هزینه",
        "brand" => "برند",
        "national_identity" => "شماره ملی",
        "supported_brands" => "برندهای پشتیبانی شده",
        "supported_services" => "سرویس های پشتیبانی شده",
        "working_day" => "روزهای کاری",
        "working_hour" => "ساعات کاری",
        "license" => "جواز",
        "activated" => "فعال",
        "parts_supplier" => "تامین کننده قطعات",
        "province_id" => "شناسه استان",
        "city_id" => "شناسه شهر",
        "count_available" => "موجودی",
        "support_space" => "فاصله پشتیبانی",
        "type" => "نوع",
        "detail_address" => "جزئیات آدرس",
        "role_ids" => "شناسه نقش ها",
        "carmodel_id" => "شناسه مدل خودرو",
        "subject" => "موضوع",
        "car_id" => "شناسه برند خودرو",
        "color_id" => "شناسه رنگ",
        "year_id" => "شناسه سال",
        "shasi" => "شاسی",
        ...
        "pelak" => "پلاک",
        "flat" => "ساختمان",
        "permission_ids" => "شناسه دسترسی ها",
        "media" => "رسانه",
        "alley" => "کوچه",
        "street" => "خیابان",
        "cars" => "خودروها",
        ...
        "category" => "دسته بندی",
        "location_type" => "نوع آدرس",
        "type_vehicle" => "نوع وسیله نقلیه",
        "name_en" => "نام انگلیسی",
        "servicecategory_id" => "شناسه زمینه سرویس",
    ],
];
